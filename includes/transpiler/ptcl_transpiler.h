...
static ptcl_transpiler_variable ptcl_transpiler_variable_create(ptcl_name_word name, ptcl_type type, bool is_inner, ptcl_statement_func_body *root)
{
...
static ptcl_transpiler_function ptcl_transpiler_function_create(ptcl_name_word name, ptcl_statement_func_body *root)
{
