...
typedef struct ptcl_transpiler_caller
{
    ptcl_func_body *root;
    ptcl_expression *caller;
    size_t start;
    size_t count;
} ptcl_transpiler_caller;

static ptcl_transpiler_variable ptcl_transpiler_variable_create(ptcl_name name, ptcl_type type, bool is_inner, ptcl_func_body *root)
{
...
static ptcl_transpiler_variable ptcl_transpiler_variable_create_this(ptcl_type type, ptcl_func_body *root)
{
    return (ptcl_transpiler_variable){
...
static ptcl_transpiler_anonymous ptcl_transpiler_anonymous_create(char *original_name, char *alias, ptcl_func_body *root)
{
...
static ptcl_transpiler_replaced ptcl_transpiler_replaced_name_create(ptcl_name name, ptcl_name replaced, ptcl_func_body *root)
{
...
static ptcl_transpiler_caller ptcl_transpiler_caller_create(ptcl_func_body *root, ptcl_expression *caller, size_t start, size_t count)
{
    return (ptcl_transpiler_caller){
        .root = root,
        .caller = caller,
        .start = start,
        .count = count};
...
static ptcl_transpiler_function ptcl_transpiler_function_create(ptcl_name name, ptcl_func_body *root)
{
