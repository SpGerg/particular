...
typedef enum ptcl_parser_error_type
{
    ...
    ptcl_parser_error_not_allowed_token_type,
    ...
    ptcl_parser_error_unknown_type_type,
    ptcl_parser_error_variable_redefinition_type,
    ptcl_parser_error_redefinition_type,
